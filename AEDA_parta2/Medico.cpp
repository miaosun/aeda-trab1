...
void Medico::addMedico(Pessoa * medico, string especialidade){}
vector<Pessoa *> *Medico::getMedicos(string especialidade){vector<Pessoa *> v; return &v;}

void Medico::addEspec(string d_esp){}
